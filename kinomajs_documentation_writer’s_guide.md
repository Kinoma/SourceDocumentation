...
**Entire section needs updating to reflect the move from Word to Github/Markdown.**
...
<!--From Caroline: Yet to be decided whether to have version number and/or publication date after the title.-->
...
- **Figure/table numbering check** — Since not automatic in Markdown, check that the numbering of all figures and tables is correct (including cross-references to them).
